...
class ProductController extends Controller
{
    ...
    public function edit($product_id){
        ...
        return view('product.edit', compact('product', 'categories', 'subcategories', 'shops'));
    }
    ...
    public function searchByProductName(){
        $products = Product::where('product_name', 'like', '%'.request()->product_name.'%')->orderby('product_name')->get();
        $categories = Category::get();
        $subcategories = Subcategory::get();
        $shops = Shop::all();
    ...
    public function searchByCategory(){
        $products = Product::where('ref_category_id', request()->ref_category_id)->orderby('product_name')->get();
        $categories = Category::get();
        $subcategories = Subcategory::get();
        $shops = Shop::all();
    ...
    public function searchBySubcategory(){
        $products = Product::where('ref_parent_category_id', request()->ref_parent_category_id)->orderby('product_name')->get();
        $categories = Category::get();
        $subcategories = Subcategory::get();
        $shops = Shop::all();
    ...
    public function searchByShopName(){
        $products = Product::where('ref_shop_id', request()->ref_shop_id)->orderby('product_name')->get();
        $categories = Category::get();
        $subcategories = Subcategory::get();
        $shops = Shop::all();
