...
<body>
    ...
    <div class="container">
        <h2 class="mb-5 mt-3">Add Shop</h2>
        ...
        <form action="{{ route('shop.store', $company_id) }}" method="post"
                ...
                <div class="col-8">
                    <div class="form-group">
                        ...
                        <input type="text" name="shop_name" value="{{ old('shop_name') }}"
                            class="form-control" placeholder="Shop 1">
                    </div>

                    <div class="form-group">
                        <label for="shop_phone">Phone</label>
                        <input type="text" name="shop_phone" value="{{ old('shop_phone') }}"
                            class="form-control" placeholder="02568 256263">
                    </div>

                    <div class="form-group">
                        <label for="shop_email">Email</label>
                        <input type="text" name="shop_email" value="{{ old('shop_email') }}"
                            class="form-control" placeholder="shop@gmail.com">
                    </div>

                    <div class="form-group">
                        <label for="shop_location">Location</label>
                        {{-- <input type="text" name="shop_location" value="{{ old('shop_location') }}"
