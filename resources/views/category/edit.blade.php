            ...
            <div class="row my-3">
                <div class="col-8">
                    <div class="form-group">
                        ...
                        <input type="text" name="category_name" value="{{ $self->category_name }}"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="ref_parent_id">
                            ...
                            @foreach($categories as $category)
                                <option value="{{ $category->category_id }}" @if($self->ref_parent_id ==
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="ref_company_id">
                            ...
                            @foreach($companies as $company)
                                <option value="{{ $company->company_id }}" @if($self->ref_company_id ==
                    ...
                    <div class=" form-group">
                        ...
                        <select class="form-control" name="category_active">
                            ...
                            <option value="1" @if($self->category_active == 1) selected @endif>Active</option>
                            <option value="0" @if($self->category_active == 0) selected @endif>Inactive</option>
                        </select>
                    </div>
